                        ...
                        <Form>
                            <FormGroup row>
                                ...
                                <div className="col" sm={12} md={10} xl={10} lg={10}>
                                    <Input type="text" id="firstname" placeholder="First Name" value={this.state.firstname}></Input>
                                </div>
                            </FormGroup> 
                            ...
                            <FormGroup row>
                                ...
                                <div className="col" sm={12} md={10} xl={10} lg={10}>
                                    <Input type="text" id="lastname" placeholder="Last Name" value={this.state.lastname}></Input>
                                </div>
                            </FormGroup>
                            ...
                            <FormGroup row>
                                ...
                                <div className="col" sm={12} md={10} xl={10} lg={10}>
                                    <Input type="tel" id="telnum" placeholder="Tel. Number" value={this.state.telnum}></Input>
                                </div>
                            </FormGroup> 
                            ...
                            <FormGroup row>
                                ...
                                <div className="col" sm={12} md={10} xl={10} lg={10}>
                                    <Input type="email" id="email" placeholder="Email" value={this.state.email}></Input>
                                </div>
                            </FormGroup>
                            ...
                            <FormGroup row>
                                ...
                                <div className="col" sm={12} md={10} xl={10} lg={10}>
                                    <Input rows="12" type="textarea" id="message" value={this.state.message}></Input>
                                </div>
                            </FormGroup>
